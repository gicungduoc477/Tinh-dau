    ...
    <div class="container-fluid">
        ...
        <div style="width: 60px; height: 60px; margin: 0 auto; overflow: hidden; background: #f8f9fc;">
                ...
                onerror="this.src='{{ asset('backend/img/no-image.png') }}'">
                                ...
                                <td>
                                    <span class="badge {{ $pro->stock > 0 ? 'badge-success' : 'badge-danger' }}">
                                        {{ $pro->stock > 0 ? 'Còn hàng' : 'Hết hàng' }}
                                    </span>
                                </td>
                                <td>{{ $pro->classification ?? '-' }}</td>
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin.product.edit', $pro->id) }}" class="btn btn-warning btn-sm shadow-sm">
    <i class="fas fa-edit"></i>
</a>
                                        <form action="{{ route('admin.product.destroy', $pro->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa sản phẩm này?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm shadow-sm ml-1">
            ...
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content border-0 shadow-lg">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="classification" class="form-control">
                                                ...
                                                <option value="Tinh dầu không nguyên chất">Tinh dầu không nguyên chất</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image" class="custom-file-input" id="imgInputModal">
                                        <label class="custom-file-label" for="imgInputModal">Chọn file</label>
                                    </div>
                                    <div class="mt-2 text-center border p-2 rounded bg-light">
                                        <img id="previewModal" src="{{ asset('backend/img/no-image.png') }}" style="max-width: 100%; height: 120px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer bg-light">
                        ...
                        <button type="submit" class="btn btn-primary px-4">Lưu lại ngay</button>
                    </div>
                </div>
            </form>
        </div>
